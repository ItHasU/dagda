 ...
 * `actionRegister` (Dagda FEATURES §11.2) — what makes `dagda.routes` and
 * `dagda.help()` enumerable and self-documenting client-side, instead of a
 * proxy that only works if you already know a name to call.
 *
