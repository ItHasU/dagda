import { _getUpdatedId, _updateForeignKeys } from "@dagda/shared/src/entities/handler";
...
import { AbstractSQLRunner, SQLConnection, SQLValue, sqlValue } from "../../sql/runner";

/** Transaction submit implementation */
export function submit<Contexts, Tables extends EntitiesTypes>(
    runner: AbstractSQLRunner<SQLConnection>,
    model: EntitiesModel<any, any>,
    transactionData: SQLTransactionData<Tables, Contexts>
